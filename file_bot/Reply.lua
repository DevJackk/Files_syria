...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[ تم زوجكم بنجاح اتفضلو اعملو واحد..😹💜](t.me/SOURCE_SYRIA)') 
return false
end
end
end
...
if text == 'طلاق' then 
send(msg.chat_id_,msg.id_, '[ تم طلاق الفجره الخاينه..🥺💜](t.me/SOURCE_SYRIA)') 
return false
end
...
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
send(msg.chat_id_,msg.id_, '[متزعلش تم رفع العضو داخل قلبك حاسب بقا ليكسره ..😂😂😂😂💔♥️](t.me/SOURCE_SYRIA)') 
return false
end
end
end
...
-- TOP
if text == "سوريا" or text == "سوريا" or text == "سوريا" or text == "سوريا" then

send(msg.chat_id_,msg.id_, '[ مبرمج السورس](t.me/SIRIA199)') 
return false
end

--Mahmoud
if text == "صاحب التليجرام" or text == "مبرمج السورس" or text == "مالك السورس" or text == "سوريا" then
send(msg.chat_id_,msg.id_, '[𝐒𝐎𝐔𝐑𝐂𝐄 SYRIA♥️](t.me/SOURCE_SYRIA)') 
return false
end
